const spam = new Map();
const spamcheck = function async(message, mute, kick, ban) {
    if (arguments.length < 4) {
        console.log('[discord-anti-spam]Appropriate number of arguments haven\'t been passed functionallity will suffer ');
    }
